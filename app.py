...
Solidity=st.slider('Solidity:',0.90,0.99)
roundness=st.slider('roundness:',0.68,0.99)
ShapeFactor1=st.slider('ShapeFactor1:',0.00,0.10)
ShapeFactor2=st.slider('ShapeFactor2:',0.00,0.10)
ShapeFactor4=st.slider('ShapeFactor4:',0.90,1.00)
